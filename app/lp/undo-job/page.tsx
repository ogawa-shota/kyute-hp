...
return <div className="uj" id="uj-top">
  ...
  <main id="uj-main">
    ...
    <section className="uj-final uj-request-section" id="uj-download"><div className="uj-wrap uj-request-layout"><div className="uj-request-copy"><p className="uj-tag"><span>サービス資料</span></p><h2 data-uj-reveal>選ばれる理由を、<br /><em>御社の一日から。</em></h2><p>企画・制作の考え方と、動画の活用方法を<br />資料にまとめてお届けします。</p><ul><li>採用したい人物像からの企画設計</li><li>1日密着で伝える、人・仕事・チーム</li><li>自社メディアと採用活動での活用</li></ul></div><div id="request-material" className="uj-request-panel"><MaterialRequestForm /></div></div></section>
